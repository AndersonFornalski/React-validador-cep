...
export class ImagemUpload5 extends React.Component{
...
//Aqui vai enviar a imagem para o Aws
    uploadImage(){
        ...
        if(selectedFile){
            ...
            actions.uploadImage5(selectedFile).then(
    ...
    renderSpinnerCircle(){
        ...
        if(!pending){
            return(
                <div className="alert alert-success">Upload feito com Sucesso da imagem 5! ja pode cadastrar</div>
            )
        }
    }
