...
export class ImagemUpload2 extends React.Component{
...
//Aqui vai enviar a imagem para o Aws
    uploadImage(){
        ...
        if(selectedFile){
            ...
            actions.uploadImage2(selectedFile).then(
    ...
    renderSpinnerCircle(){
        ...
        if(!pending){
            return(
                <div className="alert alert-success">Upload feito com Sucesso da imagem 2! ja pode salvar</div>
            )
        }
    }
